...
print(f'Run pip install -r requirements.txt to install requirements.') 
print("\n")
print("#"* 58)
...
while True:
	...
	try:
		...
		print(f'Incorrect ip address try again!!!')
...
for i in range(port_min,port_max+1):
	...
	if 'open' in res: # check state in res variable
		print(f'port {i} is {res}.') # print open ports.
	else:
		print(f'port {i} is {res}.') # print close ports.
